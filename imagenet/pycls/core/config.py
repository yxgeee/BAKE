...
_C.TRAIN.SHUFFLE_BN = False

_C.TRAIN.USE_BAKE = False
_C.TRAIN.OMEGA = 0.5
_C.TRAIN.TEMP = 4.
_C.TRAIN.LAMBDA = 0.
_C.TRAIN.GLOBAL_KE = True

_C.TRAIN.IS_CUTMIX = False
_C.TRAIN.CUTMIX = CfgNode()
_C.TRAIN.CUTMIX.PROB = 1.0
_C.TRAIN.CUTMIX.BETA = 1.0
_C.TRAIN.CUTMIX.SMOOTHING = 0.0
_C.TRAIN.CUTMIX.OFF_EPOCH = 5

_C.TRAIN.JITTER = False
